...
static const int REQUIRE_PROTOCOL_VERSION = 90000;

static const int MAINNET_MIN_HEIGHT = 3000000;
static const int TESTNET_MIN_HEIGHT = 500000;

static const std::string seeder_version = "/vericoin-seeder:2.0.0/";
